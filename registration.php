...
if(isset($_POST['s'])){
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST"){
        ...
        $a_no=$_POST['huduma_number'];
       // $password=md5($u_pass);
        $reg = "INSERT INTO user(u_name, u_id, u_pass, u_addr, a_no, gen, mob) VALUES ('$u_name','$u_id','$u_pass','$u_addr','$a_no','$gen','$mob')"; 
...
<div class="video" style="margin-top: 5%"> 
	<div class="center-container">
		 <div class="bg-agile">
          ...
          <p style="color:#dfdfdf">Huduma Number</p><input type="text"  name="huduma_number"/>
